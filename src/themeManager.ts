export class ThemeManager {
  ...
  private themeIcon: HTMLElement = document.getElementById('themeIcon') as HTMLElement;
  ...
  private searchBar: HTMLInputElement = document.getElementById('search-bar') as HTMLInputElement;
  private navbuttons: NodeListOf<HTMLButtonElement> = document.querySelectorAll('.btn');
